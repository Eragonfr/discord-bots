...
async def hug(ctx):
    ...
    await client.send_message(ctx.message.channel, ':hugging: {} reçois un câlin de {}'.format(name, auteur))
...
client.run('NDAwNzAxMDkwMTcxMDYwMjM1.DZrARA.fU2m5M0l4z_Wjr_6NUJAxfJ_12A')
